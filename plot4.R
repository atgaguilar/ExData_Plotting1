...
with(PCon, plot(V1,V3, type="l", xlab = "", ylab = "Global Active Power (kilowatts)"))

with(PCon, plot(V1,V5, type="l", xlab = "datetime", ylab = "Voltage"))
...
with(PCon, plot(V1,V4, type="l", xlab = "datetime", ylab = "Global_reactive_power"))